...
class SearchSuggestions {
  ...
  factory SearchSuggestions.fromJson(Map<String, dynamic> json) {
    ...
    final suggestions =
        (json['suggestions'] as List).map((i) => i as String).toList();
...
class SearchResult {
  ...
  SearchResult(this.artists, this.albums, this.tracks, this.playlists,
      this.podcasts, this.podcastEpisodes);
  ...
  factory SearchResult.fromJson(Map<String, dynamic> json) {
    ...
    if (json['artists'] != null) {
      ...
      json['artists']['results']
          .forEach((a) => artists!.results.add(Artist.fromJson(a)));
    }
    ...
    if (json['albums'] != null) {
      ...
      json['albums']['results']
          .forEach((a) => albums!.results.add(Album.fromJson(a)));
    }
    ...
    if (json['tracks'] != null) {
      ...
      json['tracks']['results']
          .forEach((a) => tracks!.results.add(Track.fromJson(a, '')));
    }
    ...
    if (json['playlists'] != null) {
      ...
      json['playlists']['results']
          .forEach((a) => playlists!.results.add(Playlist.fromJson(a)));
    }

    ResultsContainer<Podcast>? podcasts;
    if (json['podcasts'] != null) {
      podcasts = ResultsContainer.fromJson(json['podcasts']);
      json['podcasts']['results']
          .forEach((a) => podcasts!.results.add(Podcast.fromJson(a)));
    }
    ...
    if (json['podcast_episodes'] != null) {
      ...
      json['podcast_episodes']['results'].forEach(
          (a) => podcastEpisodes!.results.add(PodcastEpisode.fromJson(a)));
    }

    return SearchResult(
        artists, albums, tracks, playlists, podcasts, podcastEpisodes);
  }
}
...
class BestResultAlbum {
  ...
  factory BestResultAlbum.fromJson(Map<String, dynamic> json) =>
      BestResultAlbum(
        id: json['id'],
        title: json['title'],
        cover:
            json['cover'] != null ? EntityCover.fromJson(json['cover']) : null,
