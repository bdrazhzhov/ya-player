...
class Station extends Equatable implements ContextId {
  ...
  Station(this.id, this.name, this.icon, this.parentId, this.restrictions2,
      this.settings2) {
  ...
  factory Station.fromJson(
      Map<String, dynamic> json, Map<String, dynamic> settingsJson) {
    StationId? parent =
        json['parentId'] != null ? StationId.fromJson(json['parentId']) : null;

    Map<String, StationRestrictions2> restrictions2 = {};
    json['restrictions2']
        .forEach((k, v) => restrictions2[k] = StationRestrictions2.fromJson(v));

    return Station(
        StationId.fromJson(json['id']),
        json['name'],
        StationIcon.fromJson(json['icon']),
        parent,
        restrictions2,
        settingsJson.map((k, v) => MapEntry(k, v.toString())));
  }
...
class StationId extends Equatable {
  ...
  Map<String, dynamic> toJson() => {'type': type, 'tag': tag};
...
class StationRestrictions2 {
  ...
  factory StationRestrictions2.fromJson(Map<String, dynamic> json) {
    ...
    json['possibleValues']
        .forEach((i) => possibleValues.add(PossibleValue.fromJson(i)));

    return StationRestrictions2(
        name: json['name'], possibleValues: possibleValues);
  }
}
...
class PossibleValue {
  ...
  PossibleValue(
      {required this.value, required this.name, this.unspecified = false});
