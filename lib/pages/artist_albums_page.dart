...
class _ArtistAlbumsPageState extends State<ArtistAlbumsPage> {
              ...
              slivers: [
                ...
                SliverGrid.builder(
                  ...
                  gridDelegate: CustomSliverGridDelegateExtent(
                      ...
                      height: itemWidth + 60),
                  itemBuilder: (_, index) =>
                      AlbumCard(albums[index], itemWidth),
                )
              ],
            );
          } else {
  ...
  PopupMenuButton<Object> buildPopupMenu(BuildContext context) {
    ...
    return PopupMenuButton<Object>(
      ...
      itemBuilder: (BuildContext context) => [
        buildMenuItem(
            l10n.artist_albumsSortByRating, AlbumsSortBy.rating, sortBy),
        buildMenuItem(l10n.artist_albumsSortByYear, AlbumsSortBy.year, sortBy),
        PopupMenuDivider(),
        buildMenuItem(
            l10n.artist_albumsSortOrderAsc, AlbumsSortOrder.asc, sortOrder),
        buildMenuItem(
            l10n.artist_albumsSortOrderDesc, AlbumsSortOrder.desc, sortOrder),
      ],
      onSelected: (value) {
  ...
  PopupMenuItem<Object> buildMenuItem(
      String text, Object value, Object compareTo) {
    return PopupMenuItem(
      value: value,
      height: 40,
      child: Text(text, style: value == compareTo ? selectedStyle : null),
    );
  }
